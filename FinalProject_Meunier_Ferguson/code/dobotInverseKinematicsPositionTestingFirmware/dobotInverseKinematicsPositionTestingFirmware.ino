...
int baseMicrosteppingMultiplier = 1;
int upperArmMicrosteppingMultiplier = 1;
int lowerArmMicrosteppingMultiplier = 1;
...
//these settings  need to be optimized, especially when using lower microstepping settings. These worked well with 1/16th, and decent with 1/8 (slipping occured if moving too fast though)
  ...
  baseAccelObj.setAcceleration(500);

  upperArmAccelObj.setMaxSpeed(10000);
  upperArmAccelObj.setSpeed(500);
  upperArmAccelObj.setAcceleration(500);

  lowerArmAccelObj.setMaxSpeed(10000);
  lowerArmAccelObj.setSpeed(500);
  lowerArmAccelObj.setAcceleration(500);
